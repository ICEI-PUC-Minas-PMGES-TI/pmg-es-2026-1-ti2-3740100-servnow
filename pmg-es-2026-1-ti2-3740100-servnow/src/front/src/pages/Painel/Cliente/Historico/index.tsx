...
export function Historico() {
  ...
  useEffect(() => {
    async function carregar() {
      ...
      try {
        const response = await fetch(`${API_URL}/api/solicitacoes/cliente/pagas`, {
  ...
  return (
    <>
      <PainelSectionHeader
        eyebrow="Resumo"
        title="Histórico"
        description="Serviços concluídos e gastos do período selecionado."
      />
      ...
      <section className="painel-card">
        ...
        <div className="painel-stats-grid">
          ...
          <div className="painel-stat-card">
            ...
            <strong className="painel-stat-valor">{formatarMoedaBrl(totalGasto)}</strong>
          </div>
        </div>
      </section>
